...
run_scenario() {
    ...
    case "$legacy" in
        ...
        previous) files=("$T/01_issue_stamp_test.sql" "$T/04_redeem_test.sql"
                          ...
                          "$T/11_kartentoken_test.sql"
                          "$T/12_kohorten_test.sql"
                          "$T/13_funktionsrechte_test.sql"
                          "$T/14_kartenstand_test.sql"
                          "$T/15_demozugang_test.sql"
                          "$T/16_karteloeschen_test.sql"
                          "$T/17_erster_stempel_test.sql"
                          ...
                          "$T/23_verwaiste_karten_test.sql"
                            "$T/24_umzugslink_test.sql") ;;

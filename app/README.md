...
Sie dient als White-Label-Grundlage für digitale Kundenbindungs-Apps im Lebensmittelhandwerk (Bäckereien, Metzgereien, Hofläden).
...
- [X] **WorkManager-Sync:** Automatischer Abgleich alle 24h.
- [X] **Wetteranzeige:** Anzeige der aktuellen Wetterdaten (OpenWeatherMap API) auf dem HomeScreen.
- [X] **Dialekt-Umschaltung:** Auswahl zwischen Hochdeutsch und Monnemer Dialekt beim App-Start.
...
- Beim ersten Start wird eine zufällige **Geräte-ID (UUID)** erzeugt und lokal verschlüsselt gespeichert.
